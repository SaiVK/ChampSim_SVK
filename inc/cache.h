...
#define PML4C_SET 1
#define PML4C_WAY 2
#define PML4C_RQ_SIZE 0
#define PML4C_WQ_SIZE 0 
#define PML4C_PQ_SIZE 0
#define PML4C_MSHR_SIZE 0
#define PML4C_LATENCY 2

// PDPT Cache
#define PDPTC_SET 1
#define PDPTC_WAY 4
#define PDPTC_RQ_SIZE 0
#define PDPTC_WQ_SIZE 0 
#define PDPTC_PQ_SIZE 0
#define PDPTC_MSHR_SIZE 0
#define PDPTC_LATENCY 2 

// PD Cache
#define PDC_SET 4
#define PDC_WAY 4
#define PDC_RQ_SIZE 0
#define PDC_WQ_SIZE 0 
#define PDC_PQ_SIZE 0
#define PDC_MSHR_SIZE 0
#define PDC_LATENCY 2 
...
class CACHE : public MEMORY {
  public:
    ...
    int  check_hit(PACKET *packet),
         invalidate_entry(uint64_t inval_addr,uint16_t pcid),
    ...
    uint32_t get_set(uint64_t address),
             get_way(uint64_t address, uint32_t set,uint16_t pcid),
