...
class O3_CPU {
  public:
    ...
    //MMU Cache for the first 3 levels of VPN, TLB is for the 4th level      
    CACHE PML4C{"PML4C", PML4C_SET, PML4C_WAY, PML4C_SET*PML4C_WAY, PML4C_WQ_SIZE, PML4C_RQ_SIZE, PML4C_PQ_SIZE, PML4C_MSHR_SIZE},
          PDPTC{"PDPTC", PDPTC_SET, PDPTC_WAY, PDPTC_SET*PDPTC_WAY, PDPTC_WQ_SIZE, PDPTC_RQ_SIZE, PDPTC_PQ_SIZE, PDPTC_MSHR_SIZE},
          PDC{"PDC", PDC_SET, PDC_WAY, PDC_SET*PDC_WAY, PDC_WQ_SIZE, PDC_RQ_SIZE, PDC_PQ_SIZE, PDC_MSHR_SIZE};    
